# YOLOv11 banana ripeness recognition

## Body

YOLOv11 Banana Maturity Recognition Detection System (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)

nc: 6 classes,
Names: ['freshripe', 'freshunripe', 'overripe', 'ripe', 'rotten', 'unripe'] ,
Dataset quantity: training set 15792 images, validation set 1525 images, test set 757 images.
